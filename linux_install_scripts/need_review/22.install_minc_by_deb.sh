#!/bin/bash
curl -L --retry 6 -o temp.deb http://packages.bic.mni.mcgill.ca/minc-toolkit/Debian/minc-toolkit-1.9.16-20170529-Ubuntu_16.04-x86_64.deb
dpkg --install temp.deb
rm temp.deb

D_DIR=/opt/minc/1.9.16
